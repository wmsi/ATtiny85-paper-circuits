 ...
 * 
 * ATtiny85 Project
 * Using note indexes (vs. period values), plays the full note scale
 * upwards in pitch and back down again.
 * 
 * 1.19.2016
 * Mckenna Cisler
...
#define NUM_NOTES 63 // number of notes above

#define NOTE_PLAY_DURATION 80000   // uS
#define NOTE_INCREMENT_DELAY 5000 // uS; how long it waits 
...
void loop() {
  ...
  {
    playNote(periodFromNoteIndex(i), NOTE_PLAY_DURATION);
    delayMicroseconds(NOTE_INCREMENT_DELAY);
  }
